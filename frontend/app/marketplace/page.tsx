          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredCatalog.map((company) => (
              <div 
                ...
                className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full"
              >
                {/* Company Header */}
                <div className="p-6 border-b border-slate-200 dark:border-slate-800 space-y-4 flex-1">
                ...
                {/* Service Offers */}
                <div className="p-6 bg-slate-50/50 dark:bg-slate-900/40 border-t border-slate-100 dark:border-slate-800/40 space-y-4">
                  ...
                  <div className="space-y-3">
                    {company.offers.map((offer) => (
                      <div
                        key={offer.id}
                        className="p-4 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl flex flex-col justify-between gap-3 group/offer hover:border-indigo-500/50 transition-colors"
                      >
                        <div className="flex items-start justify-between gap-2">
                          <div>
                            ...
                            <span className="inline-block mt-1 px-2 py-0.5 text-[8px] font-black uppercase tracking-wider bg-slate-100 dark:bg-slate-900 rounded-md text-slate-500 dark:text-slate-450">
                          ...
                          <div className="text-right">
                            ...
                            <span className="text-[10px] text-slate-450 font-bold block">грн/міс</span>
                          </div>
                        </div>
                        ...
                        <button
                          ...
                          className="w-full mt-1 py-2 bg-slate-900 dark:bg-slate-800 hover:bg-indigo-650 dark:hover:bg-indigo-600 text-white rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1 shadow-sm"
                        >
                ...
                {/* Company Footer Stats info */}
                <div className="p-4 bg-slate-100/50 dark:bg-slate-950/40 border-t border-slate-200 dark:border-slate-800/80 flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-450 font-bold">
                  <span className="flex items-center gap-1">
                    <Clock className="w-3.5 h-3.5 text-slate-400" />
                    Вільних місць: {company.free_slots}
                  </span>
                  <span className="inline-flex items-center gap-1 px-2.5 py-0.5 bg-emerald-500/10 text-emerald-600 rounded-full border border-emerald-500/20">
